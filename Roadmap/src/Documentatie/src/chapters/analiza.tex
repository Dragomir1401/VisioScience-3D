...
\begin{itemize}
    ...
    \item S-ar dori mai multă interactivitate cu scenele.
...
\begin{itemize}
    ...
    \item \textbf{Accesibilitate}: am ales să folosim o paletă de culori care să fie ușor de privit și să nu obosească ochii utilizatorului
\end{itemize}
