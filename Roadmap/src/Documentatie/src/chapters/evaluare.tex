...
\section{Statistici de dezvoltare}
Din punct de vedere al dezvoltării software proiectul a conținut:
\begin{itemize}
  \item \textbf{Dimensiune back-end}: peste 8500 de linii de cod.
  \item \textbf{Dimensiune front-end}: peste 24500 de linii de cod.
  \item \textbf{Dimensiune fișiere de configurare}: peste 800 de linii.
  \item \textbf{Dimensiune cod LaTeX}: peste 2900 de linii.
  \item \textbf{Număr de commituri}: peste 340 de commituri în repositoriul GitHub.
\end{itemize}
