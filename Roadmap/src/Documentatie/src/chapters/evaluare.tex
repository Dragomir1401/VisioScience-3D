...
\begin{itemize}
  \item \textbf{Dimensiune back-end}: peste 6000 de linii de cod.
  \item \textbf{Dimensiune front-end}: peste 20000 de linii de cod.
  \item \textbf{Dimensiune fișiere de configurare}: peste 800 de linii.
  \item \textbf{Dimensiune cod LaTeX}: peste 2500 de linii.
  \item \textbf{Număr de commituri}: peste 300 de commituri în GitHub.
\end{itemize}
