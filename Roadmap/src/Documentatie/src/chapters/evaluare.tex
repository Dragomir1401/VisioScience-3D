...
\subsection{Analiză comparativă pe metrici}
...
\subsection{Statistici de dezvoltare}
Din punct de vedere al dezvoltării software proiectul a conținut:
\begin{itemize}
  \item \textbf{Dimensiune back-end}: peste 3500 de linii de cod.
  \item \textbf{Dimensiune front-end}: peste 17000 de linii de cod.
  \item \textbf{Dimensiune fișiere de configurare}: peste 800 de linii.
  \item \textbf{Dimensiune cod LaTeX}: peste 2500 de linii.
  \item \textbf{Număr de commituri}: peste 250 de commituri în GitHub.
\end{itemize}
