...
după rotire.
\fig[width=0.3\textwidth]{imgs/interfata.png}{fig:interfata}{Interfața meniului principal}

interfața profilului este simplă și ușor de folosit, având elemente care ies ușor în evidență
...
\texttt{keydown}) şi gestionate în interiorul declanșatorului \texttt{useFrame} din \texttt{\@react-three/fiber},
permiţând controlul direct al rotaţiei scenei în funcţie de interacţiunea utilizatorului.
Starea şi logica aplicației se propagă în lumea 3D, creând o leagătură reactivă între UI-ul
