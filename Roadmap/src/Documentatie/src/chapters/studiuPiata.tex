...
În primul rând, ea reprezintă \textbf{o singură platformă completă pentru toate materiile STEM} (în timp ce 
...
\textbf{simulări 3D real-time și configurabile} (Mozaweb de exemplu are mult suport pentru scene 3D, dar ele sunt predefinite şi 
...
\textbf{panoul de monitorizare a progresului} (lipsa raportării în timp real este o 
...
În plus, \textbf{gamificarea} (majoritatea platformelor nu au un sistem de gamificare bine definit; 
