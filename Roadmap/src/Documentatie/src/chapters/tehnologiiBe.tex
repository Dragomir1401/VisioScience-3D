...
spec: replicas,selector: matchLabels: app, template:
  metadata: labels: app, spec: containers: - name, image, ports, env
\end{lstlisting}
...
metadata: name, spec: accessModes, resources: requests: storage
\end{lstlisting}
...
\begin{itemize}
  ...
  şi o încărcăm pe DockerHub sub numele \texttt{dragomir1401/\$SERVICIU:latest}.
